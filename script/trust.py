...
class trust(unittest.TestCase):
    ...
    def test01_trust_request(self):
        ...
        logging.info("trust_register = {}".format(response.json()))
    ...
    #     #2.获取充值验证码
    #
    #     response = self.trust_api.get_recharge_verify_code(self.session)
    #     logging.info("get recharge verify code = {}".format(response.text))
    #     self.assertEqual(200,response.status_code)
    #     #3.发送充值请求
